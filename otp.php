                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7 mx-auto mt-5 mb-3">
                            <h1 class="text-white">Please Provide OTP</h1>
                        </div>
                        <div class="col-md-7 mx-auto">
                            <form action="#" method="POST">
                                <div class="form-group">
                                    <label for="otp" class="text-white">One Time Passcode</label>
                                    <input type="text" name="otp" id="otp" class="form-control  bg-dark text-white ">
                                </div>
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn bg-gradient-theme btn-lg w-100">Continue</button>
                                </div>
                            </form>
                        </div>
                    </div>
